...
export async function createSignupVerification({ name, email, password, isAdmin }) {
  ...
  await transporter.sendMail({
    ...
    replyTo: from,
    to: email,
    subject: "Your SmartEprint verification code",
    text: `Your SmartEprint verification code is ${otp}. It expires in ${OTP_EXPIRY_MINUTES} minutes.`,
    html: `
      <div style="font-family:Arial,sans-serif;max-width:560px;margin:auto;padding:24px;color:#172033">
        <h2 style="margin:0 0 12px;color:#0b5c91">Verify your SmartEprint account</h2>
